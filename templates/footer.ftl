    <footer class="page-footer light-blue darken-3">
        ...
        <div class="row">
          <#if (!(numberOfPages??) || (numberOfPages == 0))>
            <div class="col s2">
			      <h5>Archivo</h5>
			      <p>
              <a href="${content.rootpath}${config.archive_file}" class="white-text">Todos los posts</a>
            </p>
            <h5>Feed</h5>
			      <p>
              <a href="<#if (content.rootpath)??>${content.rootpath}<#else></#if>${config.feed_file}" class="white-text">Suscripci&oacute;n</a>
            </p>
	        </div>
	        <div class="col s7">
          ...
          <div class="col s3 right-align social-icons">
          <#else>
          <div class="col s12 right-align social-icons">
          </#if>
      ...
      <div class="footer-copyright">
        <div class="container">
          <p class="center-align">&copy; 2020 | Mixed with <a class="footer-link white-text" href="http://materializecss.com/" target="_blank">Materialize</a> | Baked with <a <a class="footer-link white-text" href="http://jbake.org">JBake</a></p>
        </div>
      </div>
    </footer>
  </body>
